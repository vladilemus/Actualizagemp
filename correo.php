...
<body>
    ...
    <div class="container">
        <div class="input-group">
            <form id="emailForm">
                <label for="email">Proporciona un correo electrónico</label>
                <input type="email" id="email" name="email" placeholder="ejemplo@domain.com" require>
                <br><br>
                <button style="margin-left: 45%;" class="button" type="submit">Mandar Correo</button>
            </form>
        </div>
    </div>
...
<script>
        document.getElementById('emailForm').addEventListener('submit', function(event) {
            ...
            if (email === 'esta@domain.com') {
                window.location.href = 'esta.php';
            } else {
                window.location.href = 'noesta.php';
            }
        });
    </script>