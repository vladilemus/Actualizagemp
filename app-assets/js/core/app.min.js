...
window.colors = {
    ...
    function(a, e, t) {
                ...
                if (t("ul.search-list li").remove(), t(this).parent().hasClass("bookmark-input") && (n = !0), "" != e) {
                    ...
                    t.getJSON(r + "data/" + p + ".json", (function(a) {
                        ...
                        for (m = 0; m < a.listItems.length; m++) {
                            if (!0 === n) {
                                s = "";
                                for (p = t("ul.nav.navbar-nav.bookmark-icons li"), v = 0; v < p.length; v++) s = a.listItems[m].name === p[v].firstChild.dataset.bsOriginalTitle ? " text-warning" : "";
                                h = feather.icons.star.toSvg({
                                    class: "bookmark-icon float-end" + s
                                })
                            }
        ...
        t(".nav-link-style").on("click", (function() {
            ...
            e = "dark-layout" !== a ? "dark-layout" : a === n ? "light-layout" : n || "light-layout", localStorage.setItem(T + "-prev-skin", a), localStorage.setItem(T + "-current-skin", e),
                function(a) {
