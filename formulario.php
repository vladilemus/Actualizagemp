...
<body>
    ...
    <div class="container">
        <div class="input-group">
            <form action="vista_doc.php" method="POST">
                <div class="row">
                    <div class="input-group col-6">
                        <label for="rfc">RFC</label>
                        <input type="text" id="rfc" name="rfc" value="Value">
                    </div>
                    <div class="input-group col-6">
                        <label for="curp">CURP</label>
                        <input type="text" id="curp" name="curp" value="Value">
                    </div>
                </div>
                <div class="row">
                    <div class="input-group col-6">
                        <label for="nombre">Nombre</label>
                        <input type="text" id="nombre" name="nombre" value="Value">
                    </div>
                    <div class="input-group col-6">
                        <label for="codigo-postal">Código Postal Fiscal</label>
                        <input type="text" id="codigo-postal" name="codigo-postal" value="Value">
                    </div>
                </div>
                <div class="input-group">
                    <label for="constancia">Adjunta tu constancia de situación fiscal</label>
...
<script>
        function valida() {
            window.location.href = "valida.php";
        }
</script>