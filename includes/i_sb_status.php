...
if ($str_check) {
    ...
    if ($consulta->totalRows > 0) {
        ...
        //$str_impresora = TRUE; 
        //$str_impresora_destino='fichas_reporte_sistema/rep_sb_status.php?';
        ...
        //$streliminar = TRUE;
        //$strnuevo = TRUE;
        //$str_javascript='<script src="metodos_javascript/js_sb_status.js"></script>';
        ...
        **************************************************************************************************************************************/
        ...
        /******************************************************FIN DE LOS MODALS*****************************************************/
            ...
            switch ($_POST['opc']) {
                ...
                $field[]=array('cve_estatus','cve_estatus','VISTA','number','OBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
                $field[]=array('status_descripcion','status_descripcion','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                    break;
                case 2:
                    /******************SELECTS(EJEMPLO)***********************************************/
