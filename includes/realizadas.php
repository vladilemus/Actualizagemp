...
if ($str_check) {
    ...
    if ($consulta->totalRows > 0) {
        ...
        $strWhere = "WHERE estatus = 'ACTUALIZADO'";   
        $a_order = '';
        ...
        $a_search_campo = array('clave_sp', 'nombre');
        $a_search_etiqueta = array('CLAVE DE SERVIDOR PUBLICO', 'NOMBRE');
        ...
        **************************************************************************************************************************************/
        ...
        /******************************************************FIN DE LOS MODALS*****************************************************/
            ...
            switch ($_POST['opc']) {
                ...
                $field[]=array('estatus','ESTATUS','VISTA','text','OBLIGATORIO','bigint', '', array(0, 12),'30','',array(),'','');
