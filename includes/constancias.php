        ...
        **************************************************************************************************************************************/
        ...
        /******************************************************FIN DE LOS MODALS*****************************************************/
            ...
            switch ($_POST['opc']) {
                ...
                $field[]=array('rfc','NOMBRE','VISTA','text','OBLIGATORIO','bigint', '', array(0, 12),'30','',array(),'','');
                $field[]=array('nombre','CURP','VISTA','text','OBLIGATORIO','bigint', '', array(0, 12),'30','',array(),'','');
                $field[]=array('codigo_post','RFC','VISTA','text','OBLIGATORIO','bigint', '', array(0, 12),'30','',array(),'','');
                $field[]=array('curp','CODIGO POSTAL','VISTA','text','OBLIGATORIO','bigint', '', array(0, 12),'30','',array(),'','');
                $field[]=array('ruta_archivo','ESTATUS','VISTA','text','OBLIGATORIO','bigint', '', array(0, 12),'30','',array(),'','');
                $field[]=array('estatus','CORREO ELECTRONIO','VISTA','text','OBLIGATORIO','bigint', '', array(0, 12),'30','',array(),'','');
        ...
        $str_entidad = "entidad_constancias.php";
