...
if ($str_check) {
    ...
    if ($consulta->totalRows > 0) {
        ...
        $boton_texto="NUEVO REGISTRO"; //LINEA 278 entidad_sp.php
        $campo = array();
        $entidad = 'SERVIDORES PUBLICOS CON INFORMACION DESACTUALIZADA';
        $btn_guardar='GUARDAR';
        $id_prin = '';
        $strWhere = 'WHERE a.cve_estatus = 1';   
        $a_order = '';
        ...
        $a_search_etiqueta = array('CLAVE DE SERVIDOR PUBLICO', 'NOMBRE', 'EMAIL');
        ...
        $tabla='dt_sp_erroneos a';
        $campos_join  = 'clave_sp, b.des_estatus ,nombre, rfc, 
codigo_post, ley_adscripcion, ley_puesto, 
cve_municipio, ley_municipio, centro_trabajo, email';
        $tabla_join = 'INNER JOIN cat_estatus b ON a.cve_estatus = b.cve_estatus';
        ...
        **************************************************************************************************************************************/
        ...
        /******************************************************FIN DE LOS MODALS*****************************************************/
            ...
            switch ($_POST['opc']) {
                ...
                $field[]=array('des_estatus','ESTATUS','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                ...
                $field[]=array('ley_municipio','ley_municipio','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('ley_adscripcion','ley_adscripcion','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('ley_puesto','ley_puesto','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('centro_trabajo','centro_trabajo','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('email','email','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                    break;
                case 2:
                    /******************SELECTS(EJEMPLO)***********************************************/
                ...
                $field[]=array('banco','banco','VISTA','number','OBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
                $field[]=array('centro_trabajo','centro_trabajo','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('clave_sp','clave_sp','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('codigo_post','codigo_post','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('cuenta','cuenta','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('curp','curp','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('cve_municipio','cve_municipio','VISTA','number','OBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
                $field[]=array('cve_nivel','cve_nivel','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('dt_sp_erroneos','dt_sp_erroneos','VISTA','text','OBLIGATORIO','bigint', '', array(0, 12),'30','',array(),'','');
                $field[]=array('email','email','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('error','error','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('ley_adscripcion','ley_adscripcion','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('ley_municipio','ley_municipio','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('ley_puesto','ley_puesto','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('lugar_pago','lugar_pago','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('nivel','nivel','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('nombre','nombre','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('rfc','rfc','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('banco','banco','VISTA','number','OBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
                $field[]=array('centro_trabajo','centro_trabajo','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
